...
def solve_tsp(list_point, order_point, distance, path, start_point, previous_point, nb_combinaison, best_distance, best_order):
    ...
    for index, point in enumerate (list_point):
        ...
        nb_combinaison, best_distance, best_order = solve_tsp(new_list_point, new_order_point, new_distance, new_path.astype(int), start_point, list_point[index], nb_combinaison, best_distance, best_order.astype(int))
...
start = time.time()
_, best_distance, best_order = solve_tsp(list_point, order_point, 0, path, start_point, previous_point, nb_combinaison, best_distance, best_order)
